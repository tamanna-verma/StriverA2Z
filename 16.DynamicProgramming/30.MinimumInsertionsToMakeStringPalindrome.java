01.Recursion 
  class Solution {
    ...
    {
        //find the longest palindromic subsequence length and subtract its length from string length

        int length = s.length();
        StringBuilder str = new StringBuilder(s).reverse();
        int n=s.length();
        int ans = helper(n-1, n-1 , s , str.toString());
        return length-ans;
...
02.Memoization - Top Down 
  ...
  class Solution {
    public int minInsertions(String s)
    {
        ...
        int ans = helper(n-1, n-1 , s , str.toString(),dp);
        return length-ans;
...
03.TABULATION - BOTTOM UP 
  class Solution {
    public int minInsertions(String s)
    {
        ...
        int ans = helper(n, n, s , str.toString(),dp);
        return length-ans;
...
class Solution {
    public int minInsertions(String s)
    {
        ...
        int ans = helper(n, n, s , str.toString(),dp,temp);
        return length-ans;
